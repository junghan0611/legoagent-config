...
### 2026-04-29 — Baron elevator v1: 모터로 바로 들어올리기

아침에 바론이가 이 그림을 보고 바로 만들기 시작했다.
이 기록은 "설명"보다 먼저 **상상이 바로 손으로 이어진 순간**을 남기기 위한 것이다.

![Baron elevator hoist v1](docs/elevator-hoist-v1-2026-04-29.jpg)

이번 버전의 목표는 아주 작다.

- 감속기어는 넣지 않는다
- SPIKE Prime 모터가 **직접 축을 돌린다**
- 축에 감긴 줄이 올라가면서 칸을 들어올린다
- 먼저 "올라간다"는 사실만 검증한다

바론이에게는 이렇게 설명하면 된다.

> 모터가 돌면 줄을 감고, 줄이 감기면 엘리베이터가 올라간다.
